...
const buttonStyles = {
  ...
  edit: "bg-blue-600 hover:bg-blue-700 focus:ring-blue-400 shadow-blue-500/50 p-2",
  delete: "bg-red-600 hover:bg-red-700 focus:ring-red-400 shadow-red-500/50 p-2",
  ...
  return (
    <motion.button
      ...
      className={`relative flex items-center justify-center gap-2 text-white rounded-lg font-medium transition duration-200 focus:outline-none focus:ring-2
        px-3 py-1 text-sm sm:px-4 sm:py-2 sm:text-base whitespace-nowrap overflow-hidden
